 ...
 *
 * Privacy Policy page template for the Ogape child theme.
...
<main id="main" class="site-main" role="main">
    ...
    <!-- ── HERO ─────────────────────────────────────────────── -->
    <section class="legal-hero" id="privacidad-hero">
        <div class="container">
    ...
    <!-- ── CONTENIDO LEGAL ───────────────────────────────────── -->
    <section class="legal-content" id="privacidad-content">
        <div class="container">
            <div class="legal-prose glass-card">
                <div class="legal-prose__body">
                    ...
                    if ( have_posts() ) :
                        ...
                        ?>
                        <p>El contenido de la Política de Privacidad será publicado próximamente.</p>
                        <?php
                    endif;
                    ?>
                </div>
